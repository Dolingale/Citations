...
let button = document.getElementById('nouveau');
let newCitation = document.getElementById('citation');
let newAuthor = document.getElementById('auteur');


button.addEventListener('click', () => {
    var random = Math.round(Math.random() * citations.length - 1) ;
    newCitation.textContent = citations[random][0];
    newAuthor.textContent = citations[random][1];
})
